/**
 * @class Ext.plugin.SortableQuestionList
 ...
 *      }
 *
 * Note: You must have infinite set to 'true' when using the SortableQuestionList plugin.
 *
 */
Ext.define('Ext.plugin.SortableQuestionList', {
	extend: 'Ext.Component',

	alias: 'plugin.sortablequestionlist',
	...
	onDragEnd: function() {
		...
		ARSnova.app.mainTabPanel.tabPanel.speakerTabPanel.sortQuestionsPanel.questionList.refresh();
	}
});
