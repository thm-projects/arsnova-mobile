...
Ext.Loader.addClassPathMappings({
  ...
  "Ext.plugins.ResizableTextArea": "app/utils/Ext.plugins.ResizableTextArea.js",
  "FreetextAnswer": "app/view/speaker/QuestionDetailsPanel.js"
});
Ext.ClassManager.addNameAlternateMappings({
  "ARSnova.BrowserDetect": [],
  "ARSnova.BrowserSupport": [],
  "ARSnova.WebSocket": [],
  "ARSnova.controller.Auth": [],
  "ARSnova.controller.Feedback": [],
  "ARSnova.controller.FlashcardQuestions": [],
  "ARSnova.controller.Lang": [],
  "ARSnova.controller.PreparationQuestions": [],
  "ARSnova.controller.Questions": [],
  "ARSnova.controller.Sessions": [],
  "ARSnova.model.ARSmodel": [],
  ...
  "ARSnova.view.QuestionStatusButton": [],
  "ARSnova.view.RolePanel": [],
  "ARSnova.view.SessionStatusButton": [],
  "ARSnova.view.TabPanel": [],
  "ARSnova.view.TextCheckfield": [],
  "ARSnova.view.about.TabPanel": [],
  "ARSnova.view.diagnosis.DiagnosisPanel": [],
  "ARSnova.view.diagnosis.StatisticsPanel": [],
  ...
  "ARSnova.view.feedbackQuestions.QuestionsPanel": [],
  ...
  "ARSnova.view.user.InClass": [],
  "ARSnova.view.user.LearnPanel": [],
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "ARSnova.view.home.TabPanel": [],
  "ARSnova.view.speaker.AudienceQuestionListItem": [
    "widget.audiencequestionlistitem"
  ],
  "ARSnova.view.speaker.AudienceQuestionPanel": [],
  "ARSnova.view.speaker.InClass": [],
  "ARSnova.view.speaker.MultiQuestionStatusButton": [],
