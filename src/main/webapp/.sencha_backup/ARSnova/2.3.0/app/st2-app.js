...
Ext.application({
	...
	//requires: ['ARSnova.view.MathJaxField', 'ARSnova.view.CustomMessageBox', 'ARSnova.view.NumericKeypad'],
    ...
    views: [].concat(
    		...
    		/* app/view */
    		['Caption', 'LoginPanel', 'MainTabPanel', 'TabPanel', 'RolePanel', 'CustomMask'], 
    		['MultiBadgeButton', 'MatrixButton', 'FreetextAnswerPanel', 'FreetextDetailAnswer'],
    		['FreetextQuestion', 'Question', 'QuestionStatusButton', 'SessionStatusButton'],
