 ...
 * Packaged languages: Bash, C, C#, C++, CSS, Go, HTML/XML, JSON, Java, JavaScript, Kotlin, Markdown, Objective-C, PHP, Perl, Python, Ruby, Scala, SQL, TeX, TypeScript, YAML
 */
...
end:/(?=#)|$/,contains:[b,o,r]},{begin:/\b(print|exec)\(/}]}}})());hljs.registerLanguage("ruby",(()=>{"use strict";function e(...e){
...
begin:"@[A-Za-z]+"}]}}})());hljs.registerLanguage("go",(()=>{"use strict";return e=>{const n={
...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},r,s]}}})());hljs.registerLanguage("csharp",(()=>{"use strict";return e=>{var n={
...
contains:a,keywords:e,illegal:"\\S"}}})());hljs.registerLanguage("kotlin",(()=>{"use strict"
;var e="\\.([0-9](_*[0-9])*)",n="[0-9a-fA-F](_*[0-9a-fA-F])*",a={
className:"number",variants:[{
begin:`(\\b([0-9](_*[0-9])*)((${e})|\\.)?|(${e}))[eE][+-]?([0-9](_*[0-9])*)[fFdD]?\\b`
},{begin:`\\b([0-9](_*[0-9])*)((${e})[fFdD]?\\b|\\.([fFdD]\\b)?)`},{
...
relevance:0,end:";",contains:[e.UNDERSCORE_TITLE_MODE]},l,c]}}})());hljs.registerLanguage("objectivec",(()=>{"use strict";return e=>{
...
begin:"\\."+e.UNDERSCORE_IDENT_RE,relevance:0}]}}})());hljs.registerLanguage("cpp",(()=>{"use strict";function e(e){
return((...e)=>e.map((e=>(e=>e?"string"==typeof e?e:e.source:null)(e))).join(""))("(",e,")?")
}return t=>{const n=(t=>{const n=t.COMMENT("//","$",{contains:[{begin:/\\\n/}]
}),r="[a-zA-Z_]\\w*::",a="(decltype\\(auto\\)|"+e(r)+"[a-zA-Z_]\\w*"+e("<[^<>]+>")+")",s={
className:"keyword",begin:"\\b[a-z\\d_]*_t\\b"},i={className:"string",
...
/*! highlightjs-line-numbers.js v1.1.0 | MIT License | https://github.com/wcoder/highlightjs-line-numbers.js */
