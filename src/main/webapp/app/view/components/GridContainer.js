...
Ext.define('ARSnova.view.components.GridContainer', {
	...
	config: {
		...
		curGridLineColor: '#4a5c66', // Current color of the grid lines.
		gridLineColor: '#4a5c66', // Default color of the grid lines.
	...
	update: function (questionObj, mark) {
		...
		if (questionObj.gridSize) {
			if (!questionObj.gridSizeX) {
