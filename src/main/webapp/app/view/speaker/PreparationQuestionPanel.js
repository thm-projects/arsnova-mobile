/*--------------------------------------------------------------------------+
 ...
 - Beschreibung: Panel zum Verwalten der Vorbereitungsfragen.
...
Ext.define('ARSnova.view.speaker.PreparationQuestionPanel', {
	...
	onActivate: function() {
		...
		ARSnova.app.questionModel.getPreparationQuestions(localStorage.getItem('keyword'), {
