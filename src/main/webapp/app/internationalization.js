	...
	switch (lang) {
		case 'de':
			...
			Messages = {
				...
				FORMAT_PLACEHOLDER: "(formulieren Sie ihre Frage mithilfe von Markdown für Textformatierung und Latex für mathematische Formeln)",
		...
		default:
			...
			Messages = {
				...
				FORMAT_PLACEHOLDER: "(formulate your question using Markdown for text formatting and LaTeX for mathematical formulae)",
