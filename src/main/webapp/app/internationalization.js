	...
	switch (lang) {
		case 'de':
			...
			Messages = {
				...
				RESET_ROUND: "Frage zurücksetzen",
				RESET_ROUND_WARNING: "Wenn die Frage zurückgesetzt wird, werden alle Antworten gelöscht und der Rundenzähler zurückgesetzt. Möchten Sie fortfahren?",
				RESET_ROUND_COMPLETED: "Die Frage wurde zurückgesetzt.",
				FIRST_ROUND: "Runde 1",
