	...
	switch (lang) {
		case 'de':
			...
			Messages = {
				...
				PICTURE_MAX_FILESIZE: "Bilddateiformat: JPEG oder PNG, Dateigröße: max. ###",
		...
		default:
			...
			Messages = {
				...
				GRID_LABEL_NUMBER_OF_DOTS: "Number of points for marking",
				GRID_LABEL_DELETE_MODERATION: "Remove template",
				ERROR: 'Notice',
				CORRECT_ANSWERS: "Correct answers",
				SETTINGS: "Settings",
				SETTINGS_HINT_TEXT: "Hint <br>Maximal filesize is 150 KB.",
				TEMPLATE_FOR_MODERATION: "Templates for opinion poll",
				TEMPLATE: "Template",
				APPLY: "Apply",
				DOWNLOAD:	"Download",
