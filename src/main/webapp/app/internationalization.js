	...
	switch (lang) {
		case 'de':
			...
			Messages = {
				...
				QUESTION_TEXT_PLACEHOLDER: "Nur die Lehrperson sieht Ihre Frage oder Kommentar. Sobald die Lehrperson Ihre Frage oder Kommentar gelesen hat, werden sie grau angezeigt. Antworten können in ARSnova nicht gegeben werden. Sie können auf Ihre Fragen und Kommentare nur in dem Browser zugreifen, den Sie gerade verwenden.",
