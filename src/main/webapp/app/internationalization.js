	...
	switch (lang) {
		case 'de':
			...
			Messages = {
				...
				CONFIRM_GUEST_SPEAKER: "Wenn Sie sich als Inkognito anmelden, ist die ARSnova-Session nur auf dem aktuellen Gerät verwaltbar. Dennoch als Inkognito anmelden?",
