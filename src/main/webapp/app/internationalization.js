	...
	switch (lang) {
		case 'de':
			...
			Messages = {
				...
				DELETE_ACCOUNT_SUCCESS: "Ihr Account wurde gelöscht.",
				DELETE_ACCOUNT_ERROR: "Ihr Account konnte nicht gelöscht werden.",
		...
		default:
			...
			Messages = {
				...
				DELETE_ACCOUNT_ERROR: "Your account could not be deleted.",
				VOTINGS: "Votings",
