 ...
 * Copy (C) 2011-2012 Christian Thomas Weber
...
>>>>>>> 415cfa7... Added ToggleButton for imagequestion to freetext question. #15216
...
Bitte beachten Sie, dass Sie keine Bilder verwenden für deren Verwendung Sie keine Rechte haben (Urheberrechtsgesetz) oder die pornografische oder volksverhetzende(§130 StGB) Inhalte bergen\n',
					Antwort abschicken?

>>>>>>> c2da6cc... #15220 Added image rights information to freetext answer
				/* user */
...
>>>>>>> c2da6cc... #15220 Added image rights information to freetext answer
				...
				SCORE_BASED_PROGRESS_EXPLANATION: [
					...
					'The individual learning progress is calculated using this formula: \\\\[ l_{\\text{Stud}} = \\frac{\\text{Points scored}}{\\text{Points achievable}} = \\frac{30}{60} \\hat{=}\\, 50\\%\\\\]\n',
					'For the whole course, the progress is calculated using the total number of students: \\\\[l_{\\text{Course}} = \\frac{\\text{Points scored by all students}}{\\text{Points achievable} \\cdot \\text{Number of students}}\\\\]'
				].join('\n'),
