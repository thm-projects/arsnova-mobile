	...
	switch (lang) {
		case 'de':
			...
			Messages = {
				...
				TEXT_CHECKER_STRICT_OPTIONS: 'Worauf soll bei der strikten Prüfung nicht geachtet werden?',
		...
		default:
			...
			Messages = {
				...
				TEXT_CHECKER_STRICT_OPTIONS: 'Which of the following options should be ignored?',
