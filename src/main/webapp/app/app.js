...
Ext.application({
	...
	controllers: ['Auth', 'Application', 'Feedback', 'Lang', 'Questions', 'FlashcardQuestions', 'PreparationQuestions', 'RoundManagement', 'Sessions', 'SessionImport', 'SessionExport', 'Statistics', 'Tracking'],
